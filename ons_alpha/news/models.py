...
class NewsPage(BasePage):
    template = "pages/news/news_page.html"
...
class NewsIndex(BasePage):
    template = "pages/news/news_index.html"
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        news = Paginator(news, settings.DEFAULT_PER_PAGE).get_page(page)
