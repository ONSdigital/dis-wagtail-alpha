...
class PersonPage(BasePage):
    template = "pages/people/person_page.html"
...
class PersonIndexPage(BasePage):
    template = "pages/people/person_index_page.html"
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        people = Paginator(self.people, settings.DEFAULT_PER_PAGE).get_page(page_number)
