...
PRINT_STYLE_SHEET_FILE_PATH_PATH=${PRINT_STYLE_SHEET_FILE_PATH_PATH:-"ons_alpha/jinja2/assets/styles"}
...
rm -rf ./ons_alpha/jinja2/components
rm -rf ./ons_alpha/jinja2/layout
mv -f templates/* ./ons_alpha/jinja2
rm -rf templates
